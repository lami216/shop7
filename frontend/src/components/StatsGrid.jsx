...
const StatsGrid = ({ stats }) => {
        return (
                <section className='mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4'>
                        <StatCard label='إجمالي التبرعات' value={`${stats.totalDonations?.toLocaleString("ar-EG") || 0} MRU`} />
                        <StatCard label='عدد عمليات التبرع' value={stats.donationCount || 0} />
                        <StatCard label='عدد المتبرعين' value={stats.donorsCount || 0} description='عدد المتبرعين المميزين' />
                        <StatCard
